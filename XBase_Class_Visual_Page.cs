...
namespace JAXBase
{
    internal class XBase_Class_Visual_Page : XBase_Class_Visual
    {
        ...
        {
            SetVisualObject(new TabControl(), "Page", "page", true, UserObject.URW);
        }
        ...
        public override string[] JAXEvents()
        {
            return
                [
                "activate","click","dblclick","deactivate","destroy","dragdrop","dragover","error","gotfocus",
        ...
        public override string[] JAXProperties()
        {
            return [
                "activecontrol,N!,0",
                "backcolor,R,240|240|240","backstyle,n,1",
                "baseclass,C!,page",
                "caption","class,C!,page","classlibrary,C!,","comment,C,","controlcount,N!,0",
                "Enabled,L,true",
